...
Sub Main()
    ...
    Else
    	...
    	'logoScreen = com_rostreamer_screen_CreateLogoScreen("pkg:/locale/default/images/hd_logo.png", "pkg:/locale/default/images/sd_logo.png")
    	'logoScreen.Show()
...
Sub PlayContent(p_contentMetaData As Object)
    ...
    While True
        ...
        If Type(message) = "roVideoScreenEvent" Then
            ...
            Else If message.GetType() = 11 Then
